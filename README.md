...
| [`.claude/commands/`](.claude/commands/) | 16 slash-команд Claude Code: `/botforge-new`, `/botforge-miniapp`, `/botforge-payments`, `/botforge-botfather` и др. |
...
16 готовых команд в [`.claude/commands/`](.claude/commands/):
...
/botforge-i18n           мультиязычность (gettext)
