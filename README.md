...
| [`.claude/commands/`](.claude/commands/) | 13 slash-команд Claude Code: `/botforge-new`, `/botforge-miniapp`, `/botforge-payments` и др. |
...
13 готовых команд в [`.claude/commands/`](.claude/commands/):
