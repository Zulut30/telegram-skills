...
Навигация админки обязательна: каждый раздел имеет кнопку «Назад»/«Админ-меню», bulk/destructive-действия требуют подтверждения, callback-и отвечают через `call.answer()`, а сложные таблицы/поиск лучше выносить в WebApp.
